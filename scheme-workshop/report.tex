...
To explore further host integration, we introduce \miniDusa{}, a \Dusa{}-inspired
...
This architecture lets us inherit tooling and  extensibility features from the
host essentially ``for free''.
